...
export function Navbar({ onMenuClick }: NavbarProps) {
  ...
  return (
    <header className="sticky top-safe z-30 flex items-center h-16 px-4 md:px-6 border-b border-[var(--color-border)] bg-[var(--color-surface)]/80 backdrop-blur-xl gap-2">
      <button
        onClick={onMenuClick}
